  ...
  const services = [
    ...
    },
    {
      ...
      features: [
        ...
        "Copy persuasivo para posts",
        "Ideias criativas alinhadas ao negócio",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground">
            Serviços completos para pequenos negócios que querem resultados reais. Sem enrolação.
          </p>
        </div>
