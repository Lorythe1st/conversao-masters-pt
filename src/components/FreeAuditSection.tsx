        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-primary/5 p-6 rounded-lg border border-primary/20 mb-12">
            <p className="text-foreground leading-relaxed">
              ...
              <strong>Importante:</strong> Esta análise não tem qualquer custo escondido. Vou explicar-te o que encontrei e o que considero essencial para o teu negócio crescer online. Depois, a decisão é 100% tua - sem pressão, sem chamadas agressivas. Como numa conversa de café entre profissionais.
            </p>
          </div>
